...
public class Authentication {
    ...
    public static boolean login(String email, String password) throws GeneralSecurityException, IOException {
    ...
    public static boolean addUser(String email, String password, String firstName, String lastName) throws GeneralSecurityException, UnsupportedEncodingException {
        byte[] salt = "12345678".getBytes();
        int iterationCount = 40000;
        int keyLength = 128;
        SecretKeySpec key = createSecretKey(password.toCharArray(),
